...
输出: 2048 samples、16-bit mono wav，可直接load进pgWavetable。
...
def gen_spectral(rng):
    ...
    for _ in range(int(rng.integers(2, 6))):
        ...
        width = rng.uniform(1.0, num_h * 0.2048)
...
def gen_chirplet(rng):
    ...
    f0, f1 = rng.uniform(1.0, 8.0), rng.uniform(2048.0, 48.0)
    if rng.random() < 0.5:
        f0, f1 = f1, f0
