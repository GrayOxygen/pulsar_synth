...
void AudioPluginAudioProcessor::prepareToPlay(double sampleRate, int samplesPerBlock) {
  ...
  // DC/subsonic blocker：4阶Butterworth高通(两个级联biquad，Q=0.5412/1.3066)、24Hz截止。
...
juce::AudioProcessorValueTreeState::ParameterLayout AudioPluginAudioProcessor::createParameterLayout() {
  ...
  // train
  params.push_back(std::make_unique<juce::AudioParameterInt>(juce::ParameterID(why::ParameterID::trainLen, 1), "Train Period", 1, 32, 1.0));
  params.push_back(std::make_unique<juce::AudioParameterInt>(juce::ParameterID(why::ParameterID::trainDutyCycleLen, 1), "Train Duty Cycle", 1, 5000, 0));
  ...
  params.push_back(std::make_unique<juce::AudioParameterFloat>(juce::ParameterID(why::ParameterID::unisonWidth, 1), "Unison Width", 0.0, 1.0, 0.7));
