...
void MainPage::midFlexBox(juce::FlexBox &midFlexBox, std::shared_ptr<juce::FlexBox> maskOptionFlexBox, std::shared_ptr<juce::FlexBox> burstMaskFlexBox,
  ...
  euclidStepFlexBox->items.add(juce::FlexItem(euclidStepLabel).withFlex(1.0).withMaxWidth(100).withMaxHeight(150));
  ...
  euclidHitFlexBox->items.add(juce::FlexItem(euclidHitLabel).withFlex(1.0).withMaxWidth(100).withMaxHeight(150));
...
void MainPage::resized() {
  ...
  mainFlexBox.items.add(juce::FlexItem(topFlexBox).withFlex(0.2).withMargin({20, 20, 0, 20}));
  mainFlexBox.items.add(juce::FlexItem(midFlexBox).withFlex(0.2).withMargin({20, 20, 0, 20}));
  mainFlexBox.items.add(juce::FlexItem(middleBottomFlexBox).withFlex(0.2).withMargin({20, 20, 0, 20}));
  mainFlexBox.items.add(juce::FlexItem(pgWaveformRowFlexBox).withFlex(0.5).withMargin({10, 10, 20, 20}));
