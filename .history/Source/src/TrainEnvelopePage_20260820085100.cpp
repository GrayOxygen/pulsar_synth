...
void TrainEnvelopePage::resized() {
  ...
  juce::FlexBox panFlexBox;
  panFlexBox.flexDirection = juce::FlexBox::Direction::row;
  panFlexBox.justifyContent = juce::FlexBox::JustifyContent::spaceAround;
  panFlexBox.alignContent = juce::FlexBox::AlignContent::flexStart;
  ...
  panFlexBox.items.add(juce::FlexItem(panDepthEnvelopeFlexBox).withFlex(0.3f));
  ...
  panFlexBox.items.add(juce::FlexItem(panEnvelopeFlexBox).withFlex(1.0f));
  ...
  panFlexBox.items.add(juce::FlexItem(dutyCycleClusterDepthFlexBox).withFlex(0.3f));
  ...
  panFlexBox.items.add(juce::FlexItem(dutyCycleClusterEnvelopeFlexBox).withFlex(1.0f));
  ...
  mainFlexBox.items.add(juce::FlexItem(panFlexBox).withFlex(2.0).withMargin({10, 10, 20, 20}));
...
void TrainEnvelopePage::setUIStyle() {
  ...
  ampEnvelopeScaleSlider.setRange(0.1, 2.0, 0.01);
  ...
  dutyCycleClusterEnvelopeYMinSlider.setRange(0.0, 4.0, 1);
  ...
  dutyCycleClusterEnvelopeYMaxSlider.setRange(4.0, 4.0, 1);
  dutyCycleClusterEnvelopeYMaxSlider.setValue(4.0);
  ...
  dutyCycleClusterDepthSlider.setRange(0.1f, 1.0f, 0.01f);
  ...
  dutyCycleClusterEnvelopeScaleSlider.setRange(0.1f, 16.0, 0.01);
  ...
  dutyCycleClusterEnvelopeCanvas.setYAxisRange(1.0f, 32 * 4.0f);
