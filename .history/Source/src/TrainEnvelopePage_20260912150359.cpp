...
void TrainEnvelopePage::setUIStyle() {
  ...
  ampEnvelopeYMinSlider.setRange(0.1, 0.5, 0.01);
  ampEnvelopeYMinSlider.setValue(0.5);
  ...
  ampEnvelopeYMaxSlider.setRange(0.5, 1.0, 0.01);
  ...
  ampEnvelopeCanvas.setYAxisRange(0.1f, 2.0f);
  ...
  // ========================== FM 包络绘制控件样式 ==========================
  fmEnvelopeLabel.setText("Formant Envelope", juce::dontSendNotification);
  ...
  fmEnvelopeYMinSlider.setRange(0.1f, 2.0f, 0.01f);
  ...
  fmEnvelopeYMaxSlider.setRange(2.0, 3, 0.01);
  fmEnvelopeYMaxSlider.setValue(2.0);
  ...
  fmEnvelopeCanvas.setYAxisRange(0.1f, 3.0f);
