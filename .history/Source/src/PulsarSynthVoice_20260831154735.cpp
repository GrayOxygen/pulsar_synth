...
void PulsarSynthVoice::spawnGrain(double baseFreq, double amFactor, double length, bool fund, double rateMod) {
  ...
  // wavetable scanning：only latches the scan rate on fundamental triggers — one full table sweep per 2048 pulsar periods (matches your envPhase timeline), direction sign preserved so ping-pong isn't
  // reset:
