...
void LfoPage::setUIStyle() {
  ...
  // ========================== FM lfo 绘制控件样式 ==========================
  fmLfoLabel.setText("FM Latch", juce::dontSendNotification);
  ...
  fmLfoYMinSlider.setRange(0.0f, 0.0f, 0.01f);
  fmLfoYMinSlider.setValue(0.0f);
  ...
  fmLfoYMaxSlider.setRange(0.0f, 1.0f, 0.01f);
  fmLfoYMaxSlider.setValue(1);
  ...
  fmLfoDepthLabel.setText("FM Latch Depth", juce::dontSendNotification);
  ...
  fmLfoCanvas.setYAxisRange(0.0f, 1.0f);

  defaultData.fill(0.0f);
  fmLfoCanvas.setEnvelopeData(defaultData);

  // ========================== am lfo 绘制控件样式 ==========================
  amLfoLabel.setText("AM Latch", juce::dontSendNotification);
  ...
  amLfoYMinSlider.setRange(0.01f, 1.0f, 0.01f);
  amLfoYMinSlider.setValue(0.01f);
  ...
  amLfoDepthLabel.setText("AM Latch Depth", juce::dontSendNotification);
  ...
  amLfoCanvas.setYAxisRange(0.01f, 1.0f);
