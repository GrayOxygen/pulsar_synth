...
void LfoPage::setUIStyle() {
  ...
  fmLfoYMinSlider.setRange(0.0f, 0.5f, 0.01f);
  ...
  fmLfoYMaxSlider.setRange(0.6, 1, 0.01f);
  ...
  amLfoYMinSlider.setRange(0.0f, 0.5f, 0.01f);
  amLfoYMinSlider.setValue(0.0f);
  ...
  amLfoYMaxSlider.setRange(1.0, 1.5, 0.1);
  amLfoYMaxSlider.setValue(1.5);
  ...
  amLfoDepthSlider.setRange(0.0, 1.0, 0.01);
  amLfoDepthLabel.setText("Depth", juce::dontSendNotification);
