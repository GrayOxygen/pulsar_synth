...
void PulsarSynthVoice::saveSnapShot() {
  ...
  snapShot.dutyCycleCluster = getCurrentDutyCycleCluster(envTimelinePhase(envIndex, kClusterEnvTimelineRate,commonVoiceState->kEnvIndexWrap.load()), commonVoiceSate->dutyCycleClusterDepthParam->load());
