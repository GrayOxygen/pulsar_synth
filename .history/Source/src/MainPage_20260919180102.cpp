...
void MainPage::midFlexBox(juce::FlexBox &midFlexBox, std::shared_ptr<juce::FlexBox> maskOptionFlexBox, std::shared_ptr<juce::FlexBox> burstMaskFlexBox,
  ...
  euclidHitFlexBox->items.add(juce::FlexItem(euclidHitSlider).withFlex(1.0f).withHeight(25.0f));
  ...
  stochasticMaskFlexBox->items.add(juce::FlexItem(stochasticMaskTextEditor).withFlex(1.0f).withHeight(25.0f));
