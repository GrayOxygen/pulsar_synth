...
constexpr int kEnvIndexWrap = static_cast<int>(kEnvLoopPeriods);
inline float envTimelinePhase(int envIndex, double rate,kEnvIndexWrap) { return static_cast<float>(std::fmod(static_cast<double>(envIndex) * rate / kEnvLoopPeriods, 1.0)); }
} // namespace
