...
void MainPage::midFlexBox(juce::FlexBox &midFlexBox, std::shared_ptr<juce::FlexBox> maskOptionFlexBox, std::shared_ptr<juce::FlexBox> burstMaskFlexBox,
  ...
  midFlexBox.items.add(
      ...
      juce::FlexItem(*maskOptionFlexBox)

          .withFlex(1.0f));

  midFlexBox.items.add(

      juce::FlexItem(*burstMaskFlexBox)

          .withFlex(1.0f));

  midFlexBox.items.add(

      juce::FlexItem(*euclidStepFlexBox)

          .withFlex(1.0f));

  midFlexBox.items.add(

      juce::FlexItem(*euclidHitFlexBox)

          .withFlex(1.0f));

  midFlexBox.items.add(

      juce::FlexItem(*stochasticMaskFlexBox)
