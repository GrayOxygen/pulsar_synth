...
void LfoPage::setUIStyle() {
  ...
  fmLfoYMaxSlider.setRange(0.0f, 24.0f, 1.0f);
  ...
  fmLfoDepthSlider.setRange(0.01, 10.0, 0.01);
  fmLfoDepthSlider.setValue(1);
