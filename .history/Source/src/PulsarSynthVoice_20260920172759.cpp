...
void PulsarSynthVoice::maskGatedSpawn() {
  ...
  if (maskPass) {
    ...
    if (harmonics > 1.0e-3f) {
      ...
      spawnGrain(snapShot.fundamentalFreq * 3.0, 0.5 * harmonics / 3.0 * (0.35f + 0.65f * h2), 1.0f, false, 1.0f);
      spawnGrain(snapShot.fundamentalFreq * 5.0, 0.5 * harmonics / 5.0 * (0.35f + 0.65f * h3), 1.0f, false, 1.0f);
    }
    ...
    if (unisonDetune > 0.01f) {
      spawnGrain(snapShot.fundamentalFreq, 0.7f, 1.0f, false, 1.0f, -unisonDetune, 0);
      spawnGrain(snapShot.fundamentalFreq, 0.7f, 1.0f, false, 1.0f, +unisonDetune, 0);
    }
  }
}
