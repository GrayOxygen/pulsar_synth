...
void PulsarSynthVoice::spawnGrain() {
  ...
  int samples =
      (currentStateDurationSampleNum - 1) / 2.0f * static_cast<float>(active) / 8.0f * static_cast<int>(getCurrentDutyCycleCluster(envPhase, commonVoiceSate->dutyCycleClusterDepthParam->load()));
