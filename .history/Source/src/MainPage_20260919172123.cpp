...
void MainPage::topFlexBox(juce::FlexBox &flexBoxTop, std::shared_ptr<juce::FlexBox> trainLenFlexBox, std::shared_ptr<juce::FlexBox> trainDutyCycleFlexBox,
  ...
  gainFlexB->flexDirection = juce::FlexBox::Direction::row;
  gainFlexBox->justifyContent = juce::FlexBox::JustifyContent::flexStart;
  gainFlexB->items.add(juce::FlexItem(outputGainLabel).withFlex(1).withMaxWidth(100));
  gainFlexB->items.add(juce::FlexItem(outputGainSlider).withFlex(2.5));
  // gainFlexB->items.add(juce::FlexItem().withFlex(0.1));
  // gainFlexB->items.add(juce::FlexItem(bpmSlider).withFlex(1));
  flexBoxTop.items.add(juce::FlexItem(*gainFlexB).withFlex(1.0f));
}
