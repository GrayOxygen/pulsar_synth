...
void TrainEnvelopePage::resized() {
  ...
  int fmLabelWidth = 30;
  int fmSliderWidth = juce::jmax(20, (fmRangeBounds.getWidth() - fmLabelWidth * 3) / 2);
  ...
  dutyCycleClusterEnvelopeYMinLabel.setBounds(dutyCycleClusterRangeBounds.removeFromLeft(clusterLabelWidth*0.5f  ));
  dutyCycleClusterEnvelopeYMinSlider.setBounds(dutyCycleClusterRangeBounds.removeFromLeft(clusterSliderWidth *0.5f ));
  dutyCycleClusterEnvelopeYMaxLabel.setBounds(dutyCycleClusterRangeBounds.removeFromLeft(clusterLabelWidth * 0.5f));
  dutyCycleClusterEnvelopeYMaxSlider.setBounds(dutyCycleClusterRangeBounds.removeFromLeft(clusterSliderWidth * 0.5f));
  dutyCycleClusterEnvelopeScaleLabel.setBounds(dutyCycleClusterRangeBounds.removeFromLeft(clusterLabelWidth));
  dutyCycleClusterEnvelopeScaleSlider.setBounds(dutyCycleClusterRangeBounds.removeFromLeft(clusterSliderWidth));
...
void TrainEnvelopePage::setUIStyle() {
  ...
  // ========================== FM 包络绘制控件样式 ==========================
  fmEnvelopeLabel.setText("Slice Pulsar Duty Cycle Envelope", juce::dontSendNotification);
  ...
  fmEnvelopeYMaxSlider.setRange(1.0, 10, 0.01);
  fmEnvelopeYMaxSlider.setValue(10);
  ...
  fmEnvelopeDepthSlider.setRange(0.1, 10.0, 0.01);
  ...
  dutyCycleRatioDepthSlider.setRange(0.1, 1.0, 0.01);
  ...
  dutyCycleClusterEnvelopeYMinSlider.setRange(1.0, 4.0, 1);
  ...
  dutyCycleClusterEnvelopeYMaxSlider.setRange(4.0, 16.0, 1);
  ...
  dutyCycleClusterEnvelopeScaleSlider.setRange(1, 128.0, 0.01);
  ...
  // NuPG式envelope dilation：<1包络掐断波形(打击感/宽带)，=1经典pulsar，>1一个包络装更多周期(overlap/稳态)
  ...
  dutyCycleClusterEnvelopeCanvas.setYAxisRange(1.0f, 2048.0f);
