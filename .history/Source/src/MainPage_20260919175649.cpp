...
void MainPage::midFlexBox(juce::FlexBox &midFlexBox, std::shared_ptr<juce::FlexBox> maskOptionFlexBox, std::shared_ptr<juce::FlexBox> burstMaskFlexBox,
  ...
  midFlexBox.items.add(

      juce::FlexItem(maskOptionComboBox)

          .withFlex(1.0f));

  midFlexBox.items.add(

      juce::FlexItem(burstMaskTextEditor)

          .withFlex(1.0f));

  midFlexBox.items.add(

      juce::FlexItem(euclidStepSlider)

          .withFlex(1.0f));

  midFlexBox.items.add(

      juce::FlexItem(euclidHitSlider)

          .withFlex(1.0f));

  midFlexBox.items.add(

      juce::FlexItem(stochasticMaskTextEditor)
  ...
  // euclidStepFlexBox->items.clear();

  // euclidStepFlexBox->items.add(juce::FlexItem(euclidStepLabel).withFlex(1.0f).withMaxWidth(100.0f).withMaxHeight(20.0f));

  // euclidStepFlexBox->items.add(juce::FlexItem(euclidStepSlider).withFlex(1.0f).withMaxWidth(100.0f).withMaxHeight(80.0f));
  ...
  // euclidHitFlexBox->items.clear();

  // euclidHitFlexBox->items.add(juce::FlexItem(euclidHitLabel).withFlex(1.0f).withMaxWidth(100.0f).withMaxHeight(20.0f));

  // euclidHitFlexBox->items.add(juce::FlexItem(euclidHitSlider).withFlex(1.0f).withMaxWidth(100.0f).withMaxHeight(80.0f));
  ...
  // stochasticMaskFlexBox->items.clear();
...
void MainPage::resized() {
  ...
  mainFlexBox.items.add(juce::FlexItem(topFlexBox).withFlex(1.0f).withMargin({20.0f, 20.0f, 0.0f, 20.0f}));
  mainFlexBox.items.add(juce::FlexItem(midFlexBox).withFlex(2.0f).withHeight(100.0f).withMargin({20.0f, 20.0f, 0.0f, 20.0f}));
  mainFlexBox.items.add(juce::FlexItem(middleBottomFlexBox).withFlex(1.0f).withMargin({20, 20, 0, 20}));
