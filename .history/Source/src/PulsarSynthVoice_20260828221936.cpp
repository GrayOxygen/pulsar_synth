...
void PulsarSynthVoice::maskGatedSpawn() {
  ...
  if (maskPass) {
    ...
    // spawnGrain(snapShot.fundamentalFreq * fmEnvelope, 0.75f, 0.75f * r);
    spawnGrain(snapShot.fundamentalFreq * fmSlice * fmEnvelope, 0.75f, 0.75f * r, false);
    spawnGrain(snapShot.fundamentalFreq * 2.0f, 0.75f, 0.75f * r, false);
    spawnGrain(snapShot.fundamentalFreq * 3.0f, 0.5f * r, 0.75f * r, false);
    spawnGrain(snapShot.fundamentalFreq * 4.0f, 0.3f * std::sin(r), 0.5f * r, false);
    // spawnGrain(snapShot.fundamentalFreq * 5.0f, (0.9f + r) / 2.0f, 0.5f * r, false);
    // spawnGrain(snapShot.fundamentalFreq * 6.0f, 0.51f, (0.35f + r) / 2.f, false);
    // spawnGrain(snapShot.fundamentalFreq * 7.0f, 0.85f, (0.3f + r) / 2.f, false);
    // if (r % 3 == 0) {
