...
void MainPage::setUIStyle() {
  ...
  bpmYMinSlider.setRange(10.0, 90.0, 1.0);
  bpmYMinSlider.setValue(60.0, juce::dontSendNotification);
  ...
  bpmYMaxSlider.setRange(10.0, 260.0, 1.0);
  bpmYMaxSlider.setValue(260.0, juce::dontSendNotification);
