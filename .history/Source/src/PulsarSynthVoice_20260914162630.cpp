...
constexpr int kEnvIndexWrap = 44100 * 4096;
inline float envTimelinePhase(int envIndex, double rate) { return static_cast<float>(std::fmod(static_cast<double>(envIndex) * rate / 44100.0, 1.0)); }
} // namespace
