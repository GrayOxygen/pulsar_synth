...
void PulsarSynthVoice::spawnGrain() {
  ...
  int samples = static_cast<int>(((currentStateDurationSampleNum - 1) / 2.0f) * static_cast<float>(getCurrentDutyCycleCluster(envPhase, commonVoiceSate->dutyCycleClusterDepthParam->load())));
