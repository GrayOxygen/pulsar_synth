...
void TrainEnvelopePage::setUIStyle() {
  ...
  amEnvelopeDepthLabel.setText("Amount", juce::dontSendNotification);
  ...
  fmEnvelopeYMinSlider.setRange(1, 8, 1);
  ...
  fmEnvelopeYMaxSlider.setRange(8, 16, 1);
  fmEnvelopeYMaxSlider.setValue(8);
  ...
  fmEnvelopeDepthSlider.setRange(0.0f, 1.0f, 0.1f);
  fmEnvelopeDepthSlider.setValue(1.0f);
  fmEnvelopeDepthLabel.setText("Amount", juce::dontSendNotification);
  ...
  fmEnvelopeCanvas.setYAxisRange(1, 16);
  ...
  panDepthLabel.setText("Amount", juce::dontSendNotification);
  ...
  dutyCycleClusterEnvelopeYMinSlider.setRange(2, 8, 1);
  dutyCycleClusterEnvelopeYMinSlider.setValue(8);
  ...
  dutyCycleClusterEnvelopeYMaxSlider.setRange(8, 32, 1);
  dutyCycleClusterEnvelopeYMaxSlider.setValue(16);
  ...
  dutyCycleClusterDepthLabel.setText("Amount", juce::dontSendNotification);
  ...
  dutyCycleClusterEnvelopeCanvas.setYAxisRange(2.0f, 32.0f);
