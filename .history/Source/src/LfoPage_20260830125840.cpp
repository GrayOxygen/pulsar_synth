...
void LfoPage::setUIStyle() {
  ...
  fmLfoYMinSlider.setRange(-7.0f, 0.0f, 0.01f);
  fmLfoYMinSlider.setValue(-7.0f);
  ...
  fmLfoYMaxSlider.setRange(0.0f, 7.0f, 0.01f);
  fmLfoYMaxSlider.setValue(7);
  ...
  fmLfoCanvas.setYAxisRange(-7.0f, 7.0f);
