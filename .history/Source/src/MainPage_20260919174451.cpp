...
void MainPage::midFlexBox(juce::FlexBox &midFlexBox, std::shared_ptr<juce::FlexBox> maskOptionFlexBox, std::shared_ptr<juce::FlexBox> burstMaskFlexBox,
  ...
  // 所有 mask 区域统一高度
  constexpr float maskRowHeight = 150.0f;
  ...
  maskOptionFlexBox->items.add(juce::FlexItem(maskComboBoxLabel).withFlex(1.0f).withMaxWidth(100.0f).withMaxHeight(20.0f));
  maskOptionFlexBox->items.add(juce::FlexItem(maskOptionComboBox).withFlex(1.0f).withMaxHeight(20.0f));
  midFlexBox.items.add(juce::FlexItem(*maskOptionFlexBox).withFlex(1.0f).withHeight(maskRowHeight));
  ...
  burstMaskFlexBox->items.add(juce::FlexItem(burstMaskLabel).withFlex(1.0f).withMaxWidth(100.0f).withMaxHeight(20.0f));
  burstMaskFlexBox->items.add(juce::FlexItem(burstMaskTextEditor).withFlex(1.0f).withMinWidth(100.0f).withMaxWidth(250.0f).withMaxHeight(150.0f));
  midFlexBox.items.add(juce::FlexItem(*burstMaskFlexBox).withFlex(1.0f).withHeight(maskRowHeight));
  ...
  euclidStepFlexBox->items.add(juce::FlexItem(euclidStepLabel).withFlex(1.0f).withMaxWidth(100.0f).withMaxHeight(20.0f));
  euclidStepFlexBox->items.add(juce::FlexItem(euclidStepSlider).withFlex(1.0f).withMaxWidth(100.0f).withMaxHeight(100.0f));
  midFlexBox.items.add(juce::FlexItem(*euclidStepFlexBox).withFlex(0.9f).withHeight(maskRowHeight));
  ...
  euclidHitFlexBox->items.add(juce::FlexItem(euclidHitLabel).withFlex(1.0f).withMaxWidth(100.0f).withMaxHeight(20.0f));
  euclidHitFlexBox->items.add(juce::FlexItem(euclidHitSlider).withFlex(1.0f).withMaxWidth(100.0f).withMaxHeight(100.0f));
  midFlexBox.items.add(juce::FlexItem(*euclidHitFlexBox).withFlex(0.7f).withHeight(maskRowHeight));
  ...
  stochasticMaskFlexBox->items.add(juce::FlexItem(stochasticMaskLabel).withFlex(1.0f).withMaxWidth(100.0f).withMaxHeight(20.0f));
  stochasticMaskFlexBox->items.add(juce::FlexItem(stochasticMaskTextEditor).withFlex(1.0f).withMaxWidth(250.0f).withMaxHeight(150.0f));
  midFlexBox.items.add(juce::FlexItem(*stochasticMaskFlexBox).withFlex(0.7f).withHeight(maskRowHeight));
}
...
void MainPage::resized() {
  ...
  extendFlexBox->items.add(juce::FlexItem(extendLabel).withFlex(2).withMaxWidth(100).withMaxHeight(20));
  ...
  mainFlexBox.items.add(juce::FlexItem(topFlexBox).withFlex(1).withMargin({20, 20, 0, 20}));
  mainFlexBox.items.add(juce::FlexItem(midFlexBox).withFlex(1).withMargin({20, 20, 0, 20}));
  mainFlexBox.items.add(juce::FlexItem(middleBottomFlexBox).withFlex(1).withMargin({20, 20, 0, 20}));
  mainFlexBox.items.add(juce::FlexItem(pgWaveformRowFlexBox).withFlex(3).withMargin({10, 10, 20, 20}));
...
void MainPage::setUIStyle() {
  ...
  euclidStepSlider.setSliderStyle(juce::Slider::LinearHorizontal);
  ...
  euclidHitSlider.setSliderStyle(juce::Slider::LinearHorizontal);
  ...
  extendLabel.setText("hamonic; detune", juce::dontSendNotification);
  ...
  setupExtendSlider(waveScanSpeedSlider, "Wave Scan Speed: stereo spread of the detuned pair");

  // ========================== Pg Waveform 包络绘制控件样式 ==========================
  pgWaveformEnvelopeLabel.setText("Pg Waveform", juce::dontSendNotification);
