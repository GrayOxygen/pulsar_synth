...
void PulsarSynthVoice::spawnGrain() {
  ...
  int samples = static_cast<int>(currentStateDurationSampleNum * snapShot.dutyCycleCluster * (1.0f * active / 8.0f));
  int delaySamples = static_cast<int>(currentStateDurationSampleNum * 1.0 + (caPitchOffset - 1.0) * jitterAtten * (1.0f * active / 8.0f));
