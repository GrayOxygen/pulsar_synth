...
void PulsarSynthVoice::maskGatedSpawn() {
  ...
  if (maskPass) {
    ...
    spawnGrain(snapShot.fundamentalFreq * 7.0f, 0.125f);
    spawnGrain(snapShot.fundamentalFreq * 11.0f, 0.125f / 2f);
  }
}
...
void PulsarSynthVoice::spawnGrain(double baseFreq, double amFactor = 1.0f) {
