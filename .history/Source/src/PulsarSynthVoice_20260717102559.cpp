...
void PulsarSynthVoice::spawnGrain() {
  ...
  float delaySamples = static_cast<int>(currentStateDurationSampleNum * (active / 8.0f));
  waveformGrains[waveformGrainWriteIdx] = {0, phaseInc, true, samples, samples, static_cast<int>(currentStateDurationSampleNum * (active / 8.0f)), 0, amp};
