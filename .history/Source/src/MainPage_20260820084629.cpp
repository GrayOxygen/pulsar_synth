...
void MainPage::midFlexBox(juce::FlexBox &midFlexBox, std::shared_ptr<juce::FlexBox> triggerFlexBox, std::shared_ptr<juce::FlexBox> maskOptionFlexBox, std::shared_ptr<juce::FlexBox> burstMaskFlexBox,
  ...
  midFlexBox.items.add(juce::FlexItem(*stochasticMaskFlexBox).withFlex(1.0f));

  // per-grain ADSR窗: random mask后同一行的4个旋钮
  adsrFlexBox->flexDirection = juce::FlexBox::Direction::column;
  adsrFlexBox->items.add(juce::FlexItem(grainAdsrLabel).withFlex(1).withMaxWidth(80).withMaxHeight(20));
  adsrFlexBox->items.add(juce::FlexItem(grainAdsrAttackSlider).withFlex(1.0).withMaxWidth(60).withMaxHeight(80));
  adsrFlexBox->items.add(juce::FlexItem(grainAdsrDecaySlider).withFlex(1.0).withMaxWidth(60).withMaxHeight(80));
  adsrFlexBox->items.add(juce::FlexItem(grainAdsrSustainSlider).withFlex(1.0).withMaxWidth(60).withMaxHeight(80));
  adsrFlexBox->items.add(juce::FlexItem(grainAdsrReleaseSlider).withFlex(1.0).withMaxWidth(60).withMaxHeight(80));
...
void MainPage::resized() {
  ...
  this->midFlexBox(midFlexBox, row10, row11, row12, row13, row14, row15, adsrFlexBox);
