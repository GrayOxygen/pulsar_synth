...
void PulsarSynthVoice::spawnGrain() {
  ...
  float scale = 0.3f + 0.7f * static_cast<float>(active) / 8.0f;
  ...
  int samples = static_cast<int>(currentStateDurationSampleNum / 2) * static_cast<int>(snapShot.dutyCycleCluster);
