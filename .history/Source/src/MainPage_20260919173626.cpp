...
void MainPage::resized() {
  ...
  mainFlexBox.items.add(juce::FlexItem(topFlexBox).withFlex(0.3).withMargin({20, 20, 0, 20}));
  mainFlexBox.items.add(juce::FlexItem(midFlexBox).withFlex(0.1).withMargin({20, 20, 0, 20}));
  mainFlexBox.items.add(juce::FlexItem(middleBottomFlexBox).withFlex(0.1).withMargin({20, 20, 0, 20}));
  mainFlexBox.items.add(juce::FlexItem(pgWaveformRowFlexBox).withFlex(0.3).withMargin({10, 10, 20, 20}));
