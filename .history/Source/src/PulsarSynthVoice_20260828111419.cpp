...
void PulsarSynthVoice::maskGatedSpawn() {
  ...
  if (maskPass) {
    ...
    if (r % 2 == 0) {
      spawnGrain(snapShot.fundamentalFreq * 3.0f, 0.5f, 0.8);
      spawnGrain(snapShot.fundamentalFreq * 5.0f, 0.7f, 0.9);
    }
    if (r % 2 == 1) {
      spawnGrain(snapShot.fundamentalFreq * 2.0f, 0.75f, 0.8);
      spawnGrain(snapShot.fundamentalFreq * 4.0f, 0.7f, 0.9);
    }
  }
