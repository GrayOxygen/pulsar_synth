...
void PulsarSynthVoice::spawnGrain() {
  ...
  int samples = static_cast<int>(((currentStateDurationSampleNum)) * static_cast<int>(getCurrentDutyCycleCluster(envPhase, commonVoiceSate->dutyCycleClusterDepthParam->load())));
