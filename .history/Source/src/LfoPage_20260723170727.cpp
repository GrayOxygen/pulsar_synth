...
void LfoPage::setUIStyle() {
  ...
  fmLfoYMinSlider.setRange(-12.0f, 0.0f, 0.01f);
  fmLfoYMinSlider.setValue(-12.0f);
  ...
  fmLfoYMaxSlider.setRange(0.0f, 12.0f, 0.01f);
  fmLfoYMaxSlider.setValue(12);
  ...
  fmLfoCanvas.setYAxisRange(-12.0f, 12.0f);
