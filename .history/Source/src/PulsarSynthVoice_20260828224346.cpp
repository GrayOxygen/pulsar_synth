...
void PulsarSynthVoice::maskGatedSpawn() {
  ...
  if (maskPass) {
    ...
    spawnGrain(snapShot.fundamentalFreq * fmSlice * fmEnvelope, 0.75f, 0.35f * r, false);
    spawnGrain(snapShot.fundamentalFreq * 2.0f, 0.75f, 0.25f * r, false);
    // spawnGrain(snapShot.fundamentalFreq * 3.0f, 0.5f * r, 0.95f * r, false);
    spawnGrain(snapShot.fundamentalFreq * 4.0f, 0.7f * std::sin(r), 0.5f * r, false);
