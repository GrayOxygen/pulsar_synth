...
void PulsarSynthVoice::maskGatedSpawn() {
  ...
  if (maskPass) {
    ...
    // spawnGrain(snapShot.fundamentalFreq * 2.0f, 0.75f, 0.75f * r);
    // spawnGrain(snapShot.fundamentalFreq * 3.0f, 0.5f, 0.75f * r);
    // spawnGrain(snapShot.fundamentalFreq * 4.0f, 0.3f, 0.5f * r);
    // spawnGrain(snapShot.fundamentalFreq * 5.0f, 0.1f, 0.5f * r);
