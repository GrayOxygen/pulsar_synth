...
void TrainEnvelopePage::setUIStyle() {
  ...
  fmEnvelopeYMinSlider.setRange(1.0f, 50.0f, 1.0f);
  ...
  fmEnvelopeYMaxSlider.setRange(50.0, 1000, 1);
  fmEnvelopeYMaxSlider.setValue(1000);
  ...
  dutyCycleRatioEnvelopeYMinSlider.setRange(0.1, 0.01, 0.01);
