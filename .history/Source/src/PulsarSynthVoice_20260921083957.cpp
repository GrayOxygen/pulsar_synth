...
inline float envTimelinePhase(int envIndex, double rate, int kEnvIndexWrap) { return static_cast<float>(std::fmod(static_cast<double>(envIndex) * rate / kEnvLoopPeriods, 1.0)); }
} // namespace
