...
void MainPage::resized() {
  ...
  mainFlexBox.items.add(juce::FlexItem(midFlexBox).withFlex(0.3).withMargin({20, 20, 0, 20}));
  mainFlexBox.items.add(juce::FlexItem(middleBottomFlexBox).withFlex(0.3).withMargin({20, 20, 0, 20})); 
