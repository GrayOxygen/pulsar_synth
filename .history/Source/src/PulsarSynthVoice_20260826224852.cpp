...
void PulsarSynthVoice::maskGatedSpawn() {
  ...
  if (maskPass) {
    ...
    if (r % 5 == 1) {
      ...
      spawnGrain(snapShot.fundamentalFreq * 3.0f, 0.65f);
    }
    if (r % 5 == 2) {
      spawnGrain(snapShot.fundamentalFreq, 1.0f);
      spawnGrain(snapShot.fundamentalFreq * 2.0f, 0.75f);
    ...
    if (r % 5 == 4) {
      ...
      spawnGrain(snapShot.fundamentalFreq * 2.0f, 0.75f);
      spawnGrain(snapShot.fundamentalFreq * 3.0f, 0.5f);
      spawnGrain(snapShot.fundamentalFreq * 4.0f, 0.45f);
      spawnGrain(snapShot.fundamentalFreq * 5.0f, 0.35f);
      spawnGrain(snapShot.fundamentalFreq * 6.0f, 0.25f);
      spawnGrain(snapShot.fundamentalFreq * 7.0f, 0.15f);
...
void PulsarSynthVoice::spawnGrain(double baseFreq, double amFactor) {
  ...
  int delaySamples = 0;
  double startPhase = 0;
  delaySamples = r < 0.3 ? active / 8.0f + driftPhase : 0.0f;
  startPhase = r > 0.3 ? active / 8.0f + driftPhase : 0.0f;
