...
void MainPage::midFlexBox(juce::FlexBox &midFlexBox, std::shared_ptr<juce::FlexBox> maskOptionFlexBox, std::shared_ptr<juce::FlexBox> burstMaskFlexBox,
  ...
  // ============================================================
  // Mid FlexBox
  // 这一整个 FlexBox 会被外层的 column 当成“一行”
  // ============================================================
  ...
  euclidStepFlexBox->items.add(juce::FlexItem(euclidStepSlider).withFlex(1.0f).withMaxWidth(100.0f));
  ...
  euclidHitFlexBox->items.add(juce::FlexItem(euclidHitSlider).withFlex(1.0f).withMaxWidth(100.0f));
