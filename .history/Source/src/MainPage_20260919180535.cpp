...
void MainPage::resized() {
  ...
  mainFlexBox.items.add(juce::FlexItem(topFlexBox).withFlex(2.0f).withMargin({20.0f, 20.0f, 0.0f, 20.0f})); // 上右下左
  ...
  mainFlexBox.items.add(juce::FlexItem(pgWaveformRowFlexBox).withFlex(1.0f).withMargin({10, 10, 20, 20}));
