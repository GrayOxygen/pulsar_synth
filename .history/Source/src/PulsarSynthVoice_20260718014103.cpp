...
void PulsarSynthVoice::spawnGrain() {
  ...
  int samples = static_cast<int>(((currentStateDurationSampleNum) / 8.0f) * static_cast<float>(getCurrentDutyCycleCluster(envPhase, commonVoiceSate->dutyCycleClusterDepthParam->load())));
