...
void PulsarSynthVoice::maskGatedSpawn() {
  ...
  if (maskPass) {
    ...
    spawnGrain(snapShot.fundamentalFreq * 3.0f, 0.5f, 0.3f);
    ...
    if (r % 5 == 0) {
      spawnGrain(snapShot.fundamentalFreq * 3.0f * fmSlice * fmEnvelope, 0.05f, 0.2);
    }
    if (r % 5 == 1) {
      spawnGrain(snapShot.fundamentalFreq * 5.0f * fmSlice * fmEnvelope, 0.05f, 0.3);
    }
    if (r % 5 == 2) {
      spawnGrain(snapShot.fundamentalFreq * 9.0f * fmSlice * fmEnvelope, 0.02f, 0.1);
    }
    if (r % 5 == 3) {
      spawnGrain(snapShot.fundamentalFreq * 11.0f * fmSlice * fmEnvelope, 0.01f, 0.7);
    }
    if (r % 5 == 4) {
