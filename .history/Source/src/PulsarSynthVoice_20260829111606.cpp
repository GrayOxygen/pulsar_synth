...
void PulsarSynthVoice::maskGatedSpawn() {
  ...
  if (maskPass) {
    ...
    spawnGrain(snapShot.fundamentalFreq * 3.0f, amLatch, 1.0f * fmLatch, false, amLatch);
    spawnGrain(snapShot.fundamentalFreq * 4.0f, amLatch, 1.0f * fmLatch, false, amLatch);
