...
float PulsarSynthVoice::getAmpEnvelopeValueAtPhase(float phase) const {
  return EnvelopeCanvas::getEnvelopeValueAtPhase(commonVoiceSate->ampEnvelopeData, phase, commonVoiceSate->ampEnvelopeScale.load());
}

float PulsarSynthVoice::getFmEnvelopeValueAtPhase(float phase) const {
  return EnvelopeCanvas::getEnvelopeValueAtPhase(commonVoiceSate->fmEnvelopeData, phase, commonVoiceSate->fmEnvelopeScale.load());
}
