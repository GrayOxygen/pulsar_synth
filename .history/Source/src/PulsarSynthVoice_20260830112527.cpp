...
void PulsarSynthVoice::maskGatedSpawn() {
  ...
  if (maskPass) {
    ...
    spawnGrain(snapShot.fundamentalFreq * 2.0f, amLatch, (1.0f + r) / 2.0f, false, triangle);
    spawnGrain(snapShot.fundamentalFreq * 3.0f, (amLatch + active / 8.0f) / 2.0f, 0.75f, false, sine);
