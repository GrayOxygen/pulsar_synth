...
void TrainEnvelopePage::setUIStyle() {
  ...
  ampEnvelopeYMinSlider.setRange(0.0, 0.5, 0.01);
  ...
  ampEnvelopeYMaxSlider.setRange(0.1, 1.0, 0.01);
  ...
  fmEnvelopeYMinSlider.setRange(0.1f, 0.5f, 0.01f);
  fmEnvelopeYMinSlider.setValue(0.5f);
  ...
  fmEnvelopeYMaxSlider.setRange(0.5, 1, 0.01);
  fmEnvelopeYMaxSlider.setValue(1.0);
