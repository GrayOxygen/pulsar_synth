...
void TrainEnvelopePage::setUIStyle() {
  ...
  fmEnvelopeYMinSlider.setRange(1, 1, 1);
  fmEnvelopeYMinSlider.setValue(1);
  ...
  fmEnvelopeYMaxSlider.setRange(2, 20, 1);
  fmEnvelopeYMaxSlider.setValue(2);
  ...
  fmEnvelopeDepthSlider.setRange(1, 10, 1);
  fmEnvelopeDepthSlider.setValue(1);
  ...
  dutyCycleClusterEnvelopeYMaxSlider.setRange(1.0, 2.0, 0.01);
  dutyCycleClusterEnvelopeYMaxSlider.setValue(2.0);
  ...
  dutyCycleClusterEnvelopeScaleSlider.setRange(0.1f, 8.0, 0.01);
  ...
  dutyCycleClusterEnvelopeCanvas.setYAxisRange(1.0f, 2.0f);
