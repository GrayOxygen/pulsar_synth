...
void PulsarSynthVoice::maskGatedSpawn() {
  ...
  if (maskPass) {
    ...
    spawnGrain(snapShot.fundamentalFreq * 2.0f, 0.75f * amLatch, 0.95f, false);
    spawnGrain(snapShot.fundamentalFreq * 3.0f, 0.5f * amLatch, (0.75f + r) / 2.0f, false);
    spawnGrain(snapShot.fundamentalFreq * 4.0f, 0.1f * std::sin(amLatch), 0.5f * r, false);
    spawnGrain(snapShot.fundamentalFreq * 5.0f, (0.9f + amLatch) / 2.0f, 0.5f * r, false);
    spawnGrain(snapShot.fundamentalFreq * 6.0f, 0.51f, (0.75f + amLatch) / 2.f, false);
    spawnGrain(snapShot.fundamentalFreq * 7.0f, 0.85f, (0.9f + amLatch) / 2.f, false);
    // if (r % 3 == 0) {
