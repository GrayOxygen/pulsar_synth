...
void TrainEnvelopePage::setUIStyle() {
  ...
  fmEnvelopeYMinSlider.setRange(1, 100, 1);
  ...
  fmEnvelopeYMaxSlider.setRange(50, 50, 50);
  fmEnvelopeYMaxSlider.setValue(50);
  ...
  fmEnvelopeCanvas.setYAxisRange(1, 50);
  ...
  dutyCycleClusterEnvelopeYMaxSlider.setRange(32, 32, 32);
  dutyCycleClusterEnvelopeYMaxSlider.setValue(32);
