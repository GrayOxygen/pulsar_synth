...
void PulsarSynthVoice::maskGatedSpawn() {
  ...
  if (maskPass) {
    spawnGrain(snapShot.fundamentalFreq);
    // spawnGrain(snapShot.fundamentalFreq * 2.0f);
    spawnGrain(snapShot.fundamentalFreq * 3.0f);
    // spawnGrain(snapShot.fundamentalFreq * 4.0f);
    spawnGrain(snapShot.fundamentalFreq * 5.0f);
    // spawnGrain(snapShot.fundamentalFreq * 6.0f);
    spawnGrain(snapShot.fundamentalFreq * 7.0f);
    spawnGrain(snapShot.fundamentalFreq * 8.0f);
    spawnGrain(snapShot.fundamentalFreq * 11.0f);
  }
}
...
void PulsarSynthVoice::spawnGrain(double baseFreq, double ampFactor) {
