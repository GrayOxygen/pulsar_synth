...
void PulsarSynthVoice::maskGatedSpawn() {
  ...
  if (maskPass) {
    ...
    spawnGrain(snapShot.fundamentalFreq * 7.0f, 0.05f, 0.3f);
    if (r % 5 == 0) {
    ...
    if (r % 5 == 1) {
      ...
      spawnGrain(snapShot.fundamentalFreq * 6.0f * fmSlice, 0.01f, 0.2f);
      spawnGrain(snapShot.fundamentalFreq * 7.0f * fmSlice, 0.02f, 0.1f);
    }
    if (r % 5 == 2) {
