...
void PulsarSynthVoice::maskGatedSpawn() {
  ...
  if (maskPass) {
    ...
    spawnGrain(snapShot.fundamentalFreq * 4.0f, 0.3f);
    spawnGrain(snapShot.fundamentalFreq * 5.0f, 0.1f);
    spawnGrain(snapShot.fundamentalFreq * 6.0f, 0.01f);
    spawnGrain(snapShot.fundamentalFreq * 7.0f, 0.05f);
    if (r % 5 == 0) {
