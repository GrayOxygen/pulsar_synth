...
void PulsarSynthVoice::maskGatedSpawn() {
  ...
  if (maskPass) {
    ...
    if (r % 5 == 1) {
      ...
      spawnGrain(snapShot.fundamentalFreq * 7.0f * fmSlice, 0.02f ,0.02f);
    }
    if (r % 5 == 2) {
      spawnGrain(snapShot.fundamentalFreq * 8.0f * fmSlice, 0.01f);
      spawnGrain(snapShot.fundamentalFreq * 9.0f * fmSlice, 0.02f);
      spawnGrain(snapShot.fundamentalFreq * 10.0f * fmSlice, 0.05f);
    }
    if (r % 5 == 3) {
