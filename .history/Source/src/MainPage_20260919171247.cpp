...
void MainPage::connectUIAndAudioParameter() {
  ...
  waveScanSpeedAttachment = std::make_unique<juce::AudioProcessorValueTreeState::SliderAttachment>(processorRef.apvts, why::ParameterID::unisonWidth, waveScanSpeedSlider);
