...
void TrainEnvelopePage::resized() {
  ...
  ampEnvelopeYMaxSlider.setBounds(rangeBounds.removeFromLeft(sliderWidth * 1.5f));
  ...
  dutyCycleRatioEnvelopeScaleLabel.setBounds(dutyCycleRatioRangeBounds.removeFromLeft(dutyLabelWidth * 1.5f));
...
void TrainEnvelopePage::setUIStyle() {
  ...
  dutyCycleClusterEnvelopeScaleSlider.setRange(1.0f, 64.0, 0.01);
