...
void PulsarSynthVoice::maskGatedSpawn() {
  ...
  if (maskPass) {
    ...
    if (r % 5 == 0) {
      spawnGrain(snapShot.fundamentalFreq * 2.0f * fmSlice, 0.01f);
      spawnGrain(snapShot.fundamentalFreq * 3.0f * fmSlice, 0.05f);
      spawnGrain(snapShot.fundamentalFreq * 4.0f * fmSlice, 0.02f);
    }
    if (r % 5 == 1) {
