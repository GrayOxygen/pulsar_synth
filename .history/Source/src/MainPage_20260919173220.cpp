...
void MainPage::resized() {
  ...
  std::shared_ptr<juce::FlexBox> row10 = std::make_shared<juce::FlexBox>(); 
  ...
  mainFlexBox.items.add(juce::FlexItem(middleBottomFlexBox).withFlex(0.9).withMargin({20, 20, 0, 20}));
