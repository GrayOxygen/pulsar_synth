...
void TrainEnvelopePage::setUIStyle() {
  ...
  fmEnvelopeYMaxSlider.setRange(2, 2, 2);
  ...
  fmEnvelopeDepthSlider.setRange(0.1f, 1.0f, 0.01f);
  ...
  fmEnvelopeScaleSlider.setRange(3000, 3000, 3000);
  fmEnvelopeScaleSlider.setValue(3000);
  fmEnvelopeScaleLabel.setText("Scale", juce::dontSendNotification);

  fmEnvelopeCanvas.setYAxisRange(1.0f, 3000.0f);
