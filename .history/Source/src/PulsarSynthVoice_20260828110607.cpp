...
void PulsarSynthVoice::maskGatedSpawn() {
  ...
  if (maskPass) {
    ...
    spawnGrain(snapShot.fundamentalFreq * 3.0f, 0.5f, 0.35f);
    // spawnGrain(snapShot.fundamentalFreq * 4.0f, 0.3f, 0.5f);
    ...
    if (r % 5 == 0) {
      spawnGrain(snapShot.fundamentalFreq * 3.0f * fmSlice * fmEnvelope, 0.05f, 0.8);
    }
    if (r % 5 == 1) {
      spawnGrain(snapShot.fundamentalFreq * 5.0f * fmSlice * fmEnvelope, 0.05f, 0.9);
    }
    if (r % 5 == 2) {
      spawnGrain(snapShot.fundamentalFreq * 9.0f * fmSlice * fmEnvelope, 0.02f, 0.6);
    }
    if (r % 5 == 3) {
      spawnGrain(snapShot.fundamentalFreq * 11.0f * fmSlice * fmEnvelope, 0.01f, 0.5);
    }
    if (r % 5 == 4) {
      spawnGrain(snapShot.fundamentalFreq * 13.0f * fmSlice * fmEnvelope, 0.03f, 0.3);
    }
  }
}
