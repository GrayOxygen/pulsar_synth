...
void PulsarSynthVoice::maskGatedSpawn() {
  ...
  if (maskPass) {
    ...
    spawnGrain(snapShot.fundamentalFreq * 2.0f, 0.25f);
    spawnGrain(snapShot.fundamentalFreq * 3.0f, 0.5f);
    spawnGrain(snapShot.fundamentalFreq * 4.0f, 0.35f);
    spawnGrain(snapShot.fundamentalFreq * 5.0f, 0.35f);
    // spawnGrain(snapShot.fundamentalFreq * 6.0f, 0.01f);
    // spawnGrain(snapShot.fundamentalFreq * 7.0f, 0.05f);
    if (r % 5 == 0) {
      spawnGrain(snapShot.fundamentalFreq * 2.0f * fmSlice, 0.75f);
      spawnGrain(snapShot.fundamentalFreq * 3.0f * fmSlice, 0.5f);
      spawnGrain(snapShot.fundamentalFreq * 4.0f * fmSlice, 0.25f);
    }
    if (r % 5 == 1) {
      spawnGrain(snapShot.fundamentalFreq * 5.0f * fmSlice, 0.25f);
      spawnGrain(snapShot.fundamentalFreq * 6.0f * fmSlice, 0.15f);
      spawnGrain(snapShot.fundamentalFreq * 7.0f * fmSlice, 0.1f);
    }
    if (r % 5 == 2) {
      spawnGrain(snapShot.fundamentalFreq * 8.0f * fmSlice, 0.15f);
      spawnGrain(snapShot.fundamentalFreq * 9.0f * fmSlice, 0.2f);
      spawnGrain(snapShot.fundamentalFreq * 10.0f * fmSlice, 0.15f);
    }
    if (r % 5 == 3) {
      spawnGrain(snapShot.fundamentalFreq * 11.0f * fmSlice, 0.05f);
      spawnGrain(snapShot.fundamentalFreq * 12.0f * fmSlice, 0.05f);
    }
    if (r % 5 == 4) {
      spawnGrain(snapShot.fundamentalFreq * 13.0f * fmSlice, 0.03f);
      spawnGrain(snapShot.fundamentalFreq * 14.0f * fmSlice, 0.03f);
    }
  }
}
