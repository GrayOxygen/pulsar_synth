...
void MainPage::connectUIAndAudioParameter() {
  ...
  envelopeScanSpeedAttachment = std::make_unique<juce::AudioProcessorValueTreeState::SliderAttachment>(processorRef.apvts, why::ParameterID::waveScanSpeed, envelopeScanSpeedSlider);
