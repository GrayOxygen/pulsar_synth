...
void LfoPage::setUIStyle() {
  ...
  fmLfoYMinSlider.setRange(-24.0f * 3.0f, 0.0f, 0.01f);
  fmLfoYMinSlider.setValue(-24.0f * 3.0f);
  ...
  fmLfoYMaxSlider.setRange(0.0f, 24.0f * 3.0f, 0.01f);
  fmLfoYMaxSlider.setValue(24 * 3.0f);
