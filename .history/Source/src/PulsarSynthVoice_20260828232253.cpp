...
void PulsarSynthVoice::maskGatedSpawn() {
  ...
  if (maskPass) {
    ...
    double amLatch = calcFmLfoInterpolation(static_cast<float>(lfoPhase), commonVoiceSate->fmLfoDepthParam->load());
    ...
    spawnGrain(snapShot.fundamentalFreq * fmSlice * fmEnvelope, 0.75f * r, 0.95f * r, false);
    spawnGrain(snapShot.fundamentalFreq * 2.0f, 0.75f, 0.95f * r, false);
    spawnGrain(snapShot.fundamentalFreq * 3.0f, 0.5f * r, (0.75f + r) / 2.0f, false);
    spawnGrain(snapShot.fundamentalFreq * 4.0f, 0.1f * std::sin(r), 0.5f * r, false);
    spawnGrain(snapShot.fundamentalFreq * 5.0f, (0.9f + r) / 2.0f, 0.5f * r, false);
    spawnGrain(snapShot.fundamentalFreq * 6.0f, 0.51f, (0.75f + r) / 2.f, false);
    spawnGrain(snapShot.fundamentalFreq * 7.0f, 0.85f, (0.9f + r) / 2.f, false);
    // if (r % 3 == 0) {
    //   spawnGrain(snapShot.fundamentalFreq * 3.0f, 0.05f, 0.8);
    //   spawnGrain(snapShot.fundamentalFreq * 5.0f, 0.05f, 0.9);
    // }
    // if (r % 3 == 1) {
    // }
    // if (r % 5 == 2) {
    //   spawnGrain(snapShot.fundamentalFreq * 9.0f, 0.02f, 0.6);
    // }
    // if (r % 5 == 3) {
    //   spawnGrain(snapShot.fundamentalFreq * 11.0f, 0.01f, 0.5);
    // }
    // if (r % 5 == 4) {
    //   spawnGrain(snapShot.fundamentalFreq * 13.0f, 0.03f, 0.3);
    // }
  }
}
...
void PulsarSynthVoice::spawnGrain(double baseFreq, double amFactor, double length, bool fund) {
  if (length <= 0)
    return;
