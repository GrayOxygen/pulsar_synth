...
void TrainEnvelopePage::setUIStyle() {
  ...
  dutyCycleClusterEnvelopeYMinSlider.setRange(0.0, 1.0, 1);
  ...
  dutyCycleClusterEnvelopeYMaxSlider.setRange(1.0, 2.0, 1);
  dutyCycleClusterEnvelopeYMaxSlider.setValue(1.0);
