...
void PulsarSynthVoice::maskGatedSpawn() {
  ...
  if (maskPass) {
    ...
    spawnGrain(snapShot.fundamentalFreq, fmEnvelope1);
    // spawnGrain(snapShot.fundamentalFreq * 2.0f, fmEnvelope2);
    // spawnGrain(snapShot.fundamentalFreq * 3.0f, fmEnvelope3);
    // spawnGrain(snapShot.fundamentalFreq * 4.0f, fmEnvelope4);
