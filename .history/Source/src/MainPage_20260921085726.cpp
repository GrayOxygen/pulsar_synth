...
void MainPage::resized() {
  ...
  extendFlexBox->items.add(juce::FlexItem(harmonicLabel).withFlex(1).withMaxWidth(100).withMaxHeight(20));
  extendFlexBox->items.add(juce::FlexItem(harmonicsSlider).withFlex(1).withMaxWidth(100).withMaxHeight(80));
  extendFlexBox->items.add(juce::FlexItem(detuneLabel).withFlex(1).withMaxWidth(100).withMaxHeight(20));
  extendFlexBox->items.add(juce::FlexItem(unisonDetuneSlider).withFlex(1).withMaxWidth(100).withMaxHeight(80));
