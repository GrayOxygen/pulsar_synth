...
void MainPage::midFlexBox(juce::FlexBox &midFlexBox, std::shared_ptr<juce::FlexBox> maskOptionFlexBox, std::shared_ptr<juce::FlexBox> burstMaskFlexBox,
  ...
  burstMaskFlexBox->items.add(juce::FlexItem(burstMaskLabel).withWidth(80.0f).withHeight(20.0f));
  ...
  euclidStepFlexBox->items.add(juce::FlexItem(euclidStepLabel).withWidth(80.0f).withHeight(20.0f));
