...
void MainPage::makeVisible() {
  ...
  addAndMakeVisible(waveScanSpeedLabelLabel);
...
void MainPage::resized() {
  ...
  mainFlexBox.items.add(juce::FlexItem(midFlexBox).withFlex(1.0f).withMargin({30.0f, 20.0f, 0.0f, 20.0f}));
  mainFlexBox.items.add(juce::FlexItem(middleBottomFlexBox).withFlex(0.7f).withMargin({30, 20, 0, 20}));
