...
void PulsarSynthVoice::maskGatedSpawn() {
  ...
  if (maskPass) {
    ...
    if (harmonics > 1.0e-3f) {
      ...
      spawnGrain(snapShot.fundamentalFreq * 2.0, harmonics / 2.0 * (0.35f + 0.65f * h2), 1.0f, false, 1.0f);
      spawnGrain(snapShot.fundamentalFreq * 3.0, harmonics / 3.0 * (0.35f + 0.65f * h3) * bright, 1.0f, false, 1.0f);
      spawnGrain(snapShot.fundamentalFreq * 4.0, harmonics / 4.0 * (0.35f + 0.65f * h4) * bright * bright, 1.0f, false, 1.0f);
    }
