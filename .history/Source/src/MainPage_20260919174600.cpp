...
midFlexBox.justifyContent =
    juce::FlexBox::JustifyContent::flexStart;

midFlexBox.alignItems =
...
maskOptionFlexBox->flexDirection =
    juce::FlexBox::Direction::row;

maskOptionFlexBox->justifyContent =
    juce::FlexBox::JustifyContent::flexStart;

maskOptionFlexBox->alignItems =
    juce::FlexBox::AlignItems::center;

maskOptionFlexBox->items.add(
    juce::FlexItem(maskComboBoxLabel)
        .withFlex(1.0f)
        .withMaxWidth(100.0f)
        .withMaxHeight(20.0f));
...
burstMaskFlexBox->flexDirection =
    juce::FlexBox::Direction::row;

burstMaskFlexBox->justifyContent =
    juce::FlexBox::JustifyContent::flexStart;

burstMaskFlexBox->alignItems =
    juce::FlexBox::AlignItems::center;

burstMaskFlexBox->items.add(
    juce::FlexItem(burstMaskLabel)
        .withFlex(1.0f)
        .withMaxWidth(100.0f)
        .withMaxHeight(20.0f));
...
euclidStepFlexBox->flexDirection =
    juce::FlexBox::Direction::row;

euclidStepFlexBox->justifyContent =
    juce::FlexBox::JustifyContent::flexStart;

euclidStepFlexBox->alignItems =
    juce::FlexBox::AlignItems::center;

euclidStepFlexBox->items.add(
    juce::FlexItem(euclidStepLabel)
        .withFlex(1.0f)
        .withMaxWidth(100.0f)
        .withMaxHeight(20.0f));
...
euclidHitFlexBox->flexDirection =
    juce::FlexBox::Direction::row;

euclidHitFlexBox->justifyContent =
    juce::FlexBox::JustifyContent::flexStart;

euclidHitFlexBox->alignItems =
    juce::FlexBox::AlignItems::center;

euclidHitFlexBox->items.add(
    juce::FlexItem(euclidHitLabel)
        .withFlex(1.0f)
        .withMaxWidth(100.0f)
        .withMaxHeight(20.0f));
...
stochasticMaskFlexBox->flexDirection =
    juce::FlexBox::Direction::row;

stochasticMaskFlexBox->justifyContent =
    juce::FlexBox::JustifyContent::flexStart;

stochasticMaskFlexBox->alignItems =
    juce::FlexBox::AlignItems::center;

stochasticMaskFlexBox->items.add(
    juce::FlexItem(stochasticMaskLabel)
        .withFlex(1.0f)
        .withMaxWidth(100.0f)
        .withMaxHeight(20.0f));
