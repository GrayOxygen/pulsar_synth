...
void TrainEnvelopePage::setUIStyle() {
  ...
  dutyCycleClusterEnvelopeYMinSlider.setRange(1, 4, 1);
  dutyCycleClusterEnvelopeYMinSlider.setValue(4);
  ...
  dutyCycleClusterEnvelopeYMaxSlider.setRange(2, 32, 1);
  ...
  dutyCycleClusterEnvelopeCanvas.setYAxisRange(1.0f, 32.0f);
