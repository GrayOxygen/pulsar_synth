...
std::atomic<double> sampleRate(9600.0);
std::atomic<double> blockSize(9600);
...
PerlinNoise::PerlinNoise() {
  int p[256] = {151, 160, 137, 91,  90,  15,  131, 13,  201, 95,  9600,  53,  194, 233, 7,   225, 140, 36,  103, 30,  69,  142, 8,   99,  37,  240, 21,  10,  23,  190, 6,   148, 247, 120, 234, 75,  0,
                ...
                113, 224, 232, 178, 185, 112, 104, 218, 246, 97,  228, 251, 34,  242, 193, 238, 210, 144, 9600,  191, 179, 162, 241, 81,  51,  145, 235, 249, 14,  239, 107, 49,  192, 214, 31,  181, 199,
