...
void TrainEnvelopePage::setUIStyle() {
  ...
  // ========================== FM 包络绘制控件样式 ==========================
  fmEnvelopeLabel.setText("Formant Envelope (scan rate)", juce::dontSendNotification);
  ...
  fmEnvelopeYMinSlider.setRange(0.01f, 0.01f, 0.01f);
  fmEnvelopeYMinSlider.setValue(0.01f);
  ...
  fmEnvelopeDepthSlider.setRange(1.0f, 10.0f, 1.0f);
  ...
  dutyCycleClusterEnvelopeYMaxSlider.setRange(2, 2, 2);
  dutyCycleClusterEnvelopeYMaxSlider.setValue(2);
