...
void MainPage::connectUIAndAudioParameter() {
  ...
  unisonWidthAttachment = std::make_unique<juce::AudioProcessorValueTreeState::SliderAttachment>(processorRef.apvts, why::ParameterID::unisonWidth, waveScanSpeedSlider);
