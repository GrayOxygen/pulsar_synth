...
void MainPage::midFlexBox(juce::FlexBox &midFlexBox, std::shared_ptr<juce::FlexBox> triggerFlexBox, std::shared_ptr<juce::FlexBox> maskOptionFlexBox, std::shared_ptr<juce::FlexBox> burstMaskFlexBox,
  ...
  adsrFlexBox->items.add(juce::FlexItem(grainAdsrAttackSlider).withFlex(2.0));
  adsrFlexBox->items.add(juce::FlexItem(grainAdsrDecaySlider).withFlex(2.0));
  adsrFlexBox->items.add(juce::FlexItem(grainAdsrSustainSlider).withFlex(2.0));
  adsrFlexBox->items.add(juce::FlexItem(grainAdsrReleaseSlider).withFlex(2.0));
