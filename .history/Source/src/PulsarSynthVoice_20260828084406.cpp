...
void PulsarSynthVoice::maskGatedSpawn() {
  ...
  if (maskPass) {
    ...
    if (r % 5 == 4) {
      ...
      spawnGrain(snapShot.fundamentalFreq * 5.0f, 0.15f);
      spawnGrain(snapShot.fundamentalFreq * 6.0f, 0.1f);
      spawnGrain(snapShot.fundamentalFreq * 7.0f, 0.05f);
      spawnGrain(snapShot.fundamentalFreq * 8.0f, 0.05f);
      spawnGrain(snapShot.fundamentalFreq * 9.0f, 0.01f);
      spawnGrain(snapShot.fundamentalFreq * 10.0f, 0.01f);
      spawnGrain(snapShot.fundamentalFreq * 11.0f, 0.01f);
    }
    spawnGrain(snapShot.fundamentalFreq * fmEnvelope, 0.01f);
  }
}
