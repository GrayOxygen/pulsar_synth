...
void PulsarSynthVoice::maskGatedSpawn() {
  ...
  if (maskPass) {
    ...
    if (r % 5 == 0) {
      ...
      spawnGrain(snapShot.fundamentalFreq * 3.0f * fmSlice, 0.05f, 0.1f);
      spawnGrain(snapShot.fundamentalFreq * 4.0f * fmSlice, 0.02f, 0.1f);
    }
    if (r % 5 == 1) {
      spawnGrain(snapShot.fundamentalFreq * 5.0f * fmSlice, 0.05f);
