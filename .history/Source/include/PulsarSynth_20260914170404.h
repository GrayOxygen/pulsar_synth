...
public:
  ...
  /**
   * Set BPM envelope data (96 samples)
  ...
  /**
   * Set AM envelope data (96 samples)
   */
  ...
  /**
   * Set FM envelope data (96 samples)
   */
  ...
  /**
   * Set Duty Cycle Ratio envelope data (96 samples)
   */
  ...
  /**
   * Set Duty Cycle Cluster envelope data (96 samples)
   */
