...
public:
  ...
  /**
   * Set BPM envelope data (441 samples)
  ...
  /**
   * Set AM envelope data (441 samples)
   */
  ...
  /**
   * Set FM envelope data (441 samples)
   */
  ...
  /**
   * Set Duty Cycle Ratio envelope data (441 samples)
   */
  ...
  /**
   * Set Duty Cycle Cluster envelope data (441 samples)
   */
