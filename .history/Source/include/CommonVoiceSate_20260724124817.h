...
public:
  ...
  std::atomic<float> dutyCycleRatioEnvelopeYMin{0.1f};
  ...
  // NuPG式envelope dilation：包络(=grain寿命)时长相对于波形周期的缩放比例。
  ...
  static constexpr int WAVETABLE_FRAMES = 16 * FRAMES_PER_FILE; // 总容量：最多文件数
