...
public:
  ...
  // async grain cloud控件：密度(每秒grain数，0=关闭)/电平/音高散布(±semitones)
  juce::Label cloudLabel;
  juce::Slider cloudDensitySlider;
  juce::Slider cloudLevelSlider;
  juce::Slider cloudPitchSpreadSlider;
  std::unique_ptr<juce::AudioProcessorValueTreeState::SliderAttachment> cloudDensityAttachment;
  std::unique_ptr<juce::AudioProcessorValueTreeState::SliderAttachment> cloudLevelAttachment;
  std::unique_ptr<juce::AudioProcessorValueTreeState::SliderAttachment> cloudPitchSpreadAttachment;
