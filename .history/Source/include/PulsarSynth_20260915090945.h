...
public:
  ...
  /**
   * Set BPM envelope data (12 samples)
  ...
  /**
   * Set AM envelope data (12 samples)
   */
  ...
  /**
   * Set FM envelope data (12 samples)
   */
  ...
  /**
   * Set Duty Cycle Ratio envelope data (12 samples)
   */
  ...
  /**
   * Set Duty Cycle Cluster envelope data (12 samples)
   */
