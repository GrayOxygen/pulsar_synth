...
public:
  ...
  /**
   * Set BPM envelope data (56 samples)
  ...
  /**
   * Set AM envelope data (56 samples)
   */
  ...
  /**
   * Set FM envelope data (56 samples)
   */
  ...
  /**
   * Set Duty Cycle Ratio envelope data (56 samples)
   */
  ...
  /**
   * Set Duty Cycle Cluster envelope data (56 samples)
   */
