...
private:
  ...
  // envelope scan across the whole train period (0..9600 mapped to train progress)
...
public:
  ...
  [[nodiscard]] std::shared_ptr<CommonVoiceState> &getCommonVoiceState() { return commonVoiceState; }

  void setCommonVoiceState(std::shared_ptr<CommonVoiceState> &commonVoiceState) {
    this->commonVoiceState = commonVoiceState;
    granular.setCommonVoiceState(commonVoiceState);
  }
