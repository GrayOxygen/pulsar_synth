...
public:
  ...
  /**
   * Set BPM envelope data (512 samples)
  ...
  /**
   * Set AM envelope data (512 samples)
   */
  ...
  /**
   * Set FM envelope data (512 samples)
   */
  ...
  /**
   * Set Duty Cycle Ratio envelope data (512 samples)
   */
  ...
  /**
   * Set Duty Cycle Cluster envelope data (512 samples)
   */
