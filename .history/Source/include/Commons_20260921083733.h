...
struct ParameterID {
  ...
  static constexpr const char *fmEnvelopeWaveform = "fmEnvelopeWaveform";
  static constexpr const char *amEnvelopeDepth = "ampEnvelopeDepth";
  static constexpr const char *fmEnvelopeDepth = "fmEnvelopeDepth";
  static constexpr const char *panDepth = "panDepth";
  static constexpr const char *dutyCycleClusterDepth = "dutyCycleClusterDepth";
  static constexpr const char *fmLfoDepth = "fmLfoDepth";
  static constexpr const char *amLfoDepth = "amLfoDepth";
  ...
  // pulsar extension：谐波层(2x/3x/4x基频的相干grain层)与unison失谐(立体声展宽)
  static constexpr const char *harmonics = "harmonics";
  static constexpr const char *unisonDetune = "unisonDetune";
  static constexpr const char *waveScanSpeed = "waveScanSpeed";
  static constexpr const char *envelopeScanSpeed = "envelopeScanSpeed";
};
