...
public:
  ...
  // pulsar extension控件：谐波层电平(0=关闭)/unison失谐(cents，0=关闭)/unison立体声宽度
  juce::Label harmonicLabel;
  juce::Label detuneLabel;
  juce::Label waveScanSpeedLabel;
  juce::Label envelopeScanSpeedLabel;
  juce::Slider harmonicsSlider;
  juce::Slider unisonDetuneSlider;
  juce::Slider waveScanSpeedSlider;
  juce::Slider envelopeScanSpeedSlider;
  ...
  std::unique_ptr<juce::AudioProcessorValueTreeState::SliderAttachment> waveScanSpeedAttachment;
  std::unique_ptr<juce::AudioProcessorValueTreeState::SliderAttachment> envelopeScanSpeedSliderAttachment;
