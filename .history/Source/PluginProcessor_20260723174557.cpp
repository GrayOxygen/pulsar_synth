...
void AudioPluginAudioProcessor::prepareToPlay(double sampleRate, int samplesPerBlock) {
  ...
  *dcFilter.state = *coefficients;
  ...
  auto coefficients = FilterCoefs::makeFirstOrderLowPass(sampleRate, 10000.0f);
  // Assign coefficients to the filter wrapper
  *dcFilter.state = *coefficients;
}
...
juce::AudioProcessorValueTreeState::ParameterLayout AudioPluginAudioProcessor::createParameterLayout() {
  ...
  params.push_back(std::make_unique<juce::AudioParameterFloat>(juce::ParameterID(why::ParameterID::dutyCycleRatioDepth, 1), "Duty Cycle Ratio Depth", 0.1, 1.0, 1.0));
  params.push_back(std::make_unique<juce::AudioParameterFloat>(juce::ParameterID(why::ParameterID::dutyCycleClusterDepth, 1), "Duty Cycle Cluster Depth", 0.1, 1.0, 1.0));
